...
<div id="login">
    <form action="index.php" class="login" method="post">
      ...
      <div id="tests">
        CASE SENSITIVE::
        Student View: faustus101@students.highline.edu  student<br>
        Org View: Faustus101@students.highline.edu org<br>
        Admin View: faustus101@students.students.highline.edu  admin<br>
        Admin View: pabronson@students. pabronson
    </div>
